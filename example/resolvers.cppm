...
struct ChildObjectResolver : Resolver<shared_state*, TestChildObject*, int, std::shared_ptr<TestObject>> {
	std::expected<std::any, FuzeHttp::Response> fetch(shared_state* state, int key, std::shared_ptr<TestObject> test_object, const std::optional<Client>& client) const override {
